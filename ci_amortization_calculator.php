...
Version: 1.0.0
Author: Amortization Calculator / www.calculator.io
...
if (!function_exists('add_shortcode')) return "No direct call for Amortization Calculator by www.calculator.io";

function display_calcio_ci_amortization_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_amortization_calculator', 'display_calcio_ci_amortization_calculator' );